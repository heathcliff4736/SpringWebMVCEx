                        ...
                        <form action="/board/modify" method="post">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="board_Id" class="form-control"
                                       value='<c:out value="${boardDTO.board_Id}"></c:out>' readonly>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="content" class="form-control"
                                       value='<c:out value="${boardDTO.content}"></c:out>' >
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="createdAt" class="form-control"
                                       value='<c:out value="${boardDTO.created_At}"></c:out>' readonly>

                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text">최종수정일시</span>
                                <input type="text" name="updatedAt" class="form-control"
                                       value='<c:out value="${boardDTO.updated_At}"></c:out>' readonly>
